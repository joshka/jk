...
This release candidate turns `jk` from a log/diff inspection helper into a dogfoodable jj workbench.
...
- Update the repository README and crate README to describe the current workbench surface rather
...
- Public README GIFs, crates.io media, and website media still need a release-media refresh before
  they should advertise the full workbench surface.
