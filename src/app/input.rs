...
use crate::action_pane::{ActionPaneKey, action_pane_visible_lines, handle_action_pane_key};
use crate::clipboard;
use crate::command::{
...
impl App {
    ...
    fn handle_view_menu_key(&mut self, code: KeyCode, viewport_height: u16) -> Result<bool> {
    ...
    fn handle_action_menu_key(&mut self, code: KeyCode) -> Result<bool> {
    ...
    fn handle_role_prompt_key(&mut self, code: KeyCode) -> Result<bool> {
    ...
    fn handle_push_remote_prompt_key(&mut self, code: KeyCode) -> Result<bool> {
    ...
    fn handle_fetch_remote_prompt_key(&mut self, code: KeyCode) -> Result<bool> {
