...
//! chosen actions, `preview` opens panes, `input` reduces shared preview keys, `completion` and
//! `rewrite_completion` run confirmed commands, and `shared` keeps only wording plus
