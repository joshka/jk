...
pub(super) struct PlainDocument {
...
impl PlainDocument {
    ...
    pub(super) fn refresh(&mut self, spec: &ViewSpec) -> Result<()> {
    ...
    pub(super) fn projection(&self) -> PinnedDocument {
