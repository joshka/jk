...
pub fn parse_revision_metadata_lines(lines: Vec<String>) -> RowMetadata<RevisionMetadata> {
...
pub fn parse_metadata_line(line: &str) -> Option<RevisionMetadata> {
    let line = line
        .char_indices()
