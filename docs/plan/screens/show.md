...
If future actions need exact file sets or template semantics, record the soft agreement and consider
a purpose-built template, structured output, or `jj_cli`/`jj_lib`.
