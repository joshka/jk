...
- likely drill-down into separate operation detail screens
- optional inline expansion for selected operation metadata is acceptable
...
- multi-select is not a first-wave need; recovery actions should target one operation at a time
