...
## Current Code
  ...
  | Push targeting          | Status/bookmark/graph push flows select an explicit bookmark, revision, or remote                      | Status-context default targeting can drift if `jj` changes push resolution       | Keep the selected target visible in the prompt and preview; prefer structured target state                                                                         |
