...
Avoid baking the owning module name into a type name when the module path already provides that
context. Prefer names like `jj::Command` over prefixed forms like `JjCommand`.
